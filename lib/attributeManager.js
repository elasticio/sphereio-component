...
exports.addProductTypeData = function(schema, cfg, cb){
    exports.promiseProductTypeData(cfg).then(function(productTypeData){
        if (productTypeData && productTypeData.body.attributes) {
            schema.in.properties.masterVariant.attributes = exports.buildAttributes(productTypeData.body.attributes);
        }
        cb(schema);
    });
};
 ...
 */
exports.buildAttributes = function (metadata, attributes) {
    var result = {};
