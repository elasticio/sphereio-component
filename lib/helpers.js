...
function centAmountFromAmount(amount){
...
function amountFromCentAmount(centAmount){
...
function centAmountsToAmounts(object) {
    _.each(object, function(value, key) {
        if (key == 'centAmount') {
            object.amount = amountFromCentAmount(object.centAmount);
...
function amountsToCentAmounts(object) {
    _.each(object, function(value, key) {
        if (key == 'amount') {
            object.centAmount = centAmountFromAmount(object.amount);
...
exports.amountFromCentAmount = amountFromCentAmount;
exports.centAmountFromAmount = centAmountFromAmount;
