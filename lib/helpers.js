...
// for each 'centAmount' field
// it adds 'amount' field keeping centAmount/100
// so you can access both centAmount and amount
function addAmountsToCentAmounts(object) {
    _.each(_.keys(object), function(key) {
        if (_.isObject(object[key])) {
            addAmountsToCentAmounts(object[key]);
...
exports.addAmountsToCentAmounts = addAmountsToCentAmounts;