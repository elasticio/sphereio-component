...
*/
var CartDiscountService, CartService, CategoryService, ChannelService, CommentService, CustomObjectService, CustomerGroupService, CustomerService, DiscountCodeService, InventoryEntryService, MessageService, OrderService, ProductDiscountService, ProductProjectionService, ProductService, ProductTypeService, ProjectService, Rest, ReviewService, ShippingMethodService, SphereClient, StateService, TaskQueue, TaxCategoryService, ZoneService, _;
...
SphereClient = (function() {
  ...
  function SphereClient(options) {
    ...
    this.cartDiscounts = new CartDiscountService(_serviceOptions);
    ...
    this.discountCodes = new DiscountCodeService(_serviceOptions);
